    ...
    <div>
      <div className="container mb-6">
        <div className="row">
          ...
          <p className="fw-medium lh-base mb-5 text-center">
              ...
              <div className="card-body pt-4 d-flex flex-column align-items-start">
                ...
                <a href="#" className="d-flex mb-5 text-decoration-none">
                  ...
                  <div className="d-flex flex-column ms-3 ">
                    <p className="text-success mb-0 mt-1 fw-semibold">
                      Wahid Ari
                    </p>
        ...
        <div className="bg-success rounded-5">
          <div className="row row-cols-1 row-cols-xl-2 justify-content-between px-6">
            <div className="pl-6 text-center text-xl-start">
              <h3 className="text-white fs-2 my-6  lh-base">
                Join 100 Compannies who boost their business with Product
              </h3>
              <a
                href="#"
                className="btn btn-success bg-white text-success fw-semibold fs-20 px-6 py-2 rounded-3"
              >
                Get This
              </a>
            </div>
